					...
					<div className='relative z-10'>
						<div className='flex flex-col sm:flex-row p-4 sm:p-6 gap-4 sm:gap-6 pb-6 sm:pb-8'>
							...
							<div className='flex flex-col justify-end items-center sm:items-start text-center sm:text-left w-full'>
								...
								<h1 className='text-3xl sm:text-7xl font-bold my-2 sm:my-4'>{currentAlbum?.title}</h1>
						...
						{/* Table Section */}
						<div className='bg-black/20 backdrop-blur-sm overflow-x-auto'>
							{/* table header */}
							<div
								className='min-w-[500px] grid grid-cols-[16px_4fr_2fr_1fr] gap-4 px-4 sm:px-10 py-2 text-xs sm:text-sm text-zinc-400 border-b border-white/5'
							>
								<div>#</div>
								<div>Title</div>
							...
							{/* songs list */}
							<div className='min-w-[500px] px-2 sm:px-6'>

...
const FeaturedSection = () => {
	const { isFetchingFeaturedSongs, featuredSongs, error } = useMusicStore();

	if (isFetchingFeaturedSongs) return <FeaturedGridSkeleton />;
			...
			{featuredSongs.map((song) => (
				...
				>
					<img
						...
						alt={song.title}
						loading="lazy"
						className='w-16 sm:w-20 h-16 sm:h-20 object-cover m-2 rounded-sm'
					/>

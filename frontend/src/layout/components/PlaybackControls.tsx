...
export const PlaybackControls = () => {
	...
	return (
		<footer className='h-28 sm:h-24 bg-gradient-to-br from-gray-900 via-gray-950 to-black text-white  border-t border-gray-900 px-3 py-2 sm:px-4 sm:py-0 fixed bottom-0 left-0 w-full z-40'>
